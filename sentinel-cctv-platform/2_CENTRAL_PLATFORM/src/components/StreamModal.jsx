          ...
          <div className="stream-modal-layout">
            ...
            <div>
              <div className="stream-meta-grid">
                ...
                <div className="item"><span>AI Mode</span><b style={{ color: camera.detection_mode === 'ANPR_DETECTION' ? 'var(--accent)' : 'var(--text-primary)' }}>{camera.detection_mode === 'ANPR_DETECTION' ? 'ANPR Plate Recognition' : (camera.detection_mode === 'VEHICLE_COUNTING' ? 'Vehicle Counting' : (camera.detection_mode === 'TRAFFIC_MONITORING' ? 'Traffic Monitoring' : 'Surveillance'))}</b></div>
